...
def ANIMAL_STARTING_HEALTH():
    return PLANT_MAX_HEALTH * pygame.math.lerp(0.2, 0.4, random.random())


def ANIMAL_STARTING_ENERGY():
    return PLANT_MAX_ENERGY * pygame.math.lerp(0.2, 0.4, random.random())
